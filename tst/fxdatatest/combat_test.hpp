...
static const CombatAttackValue kAttacks[] PROGMEM = {
    ...
    // windup, active, recover, dmg, tell, artSheet, artFrame, artMode (bih.4)
    {MOVE_LUNGE,
     26,
     0,
     0,
     ...
     combat_expect::ATTACK_HEAVY_BITE_ART_SHEET,
     combat_expect::ATTACK_HEAVY_BITE_ART_FRAME,
     combat_expect::ATTACK_HEAVY_BITE_ART_MODE},
    {MOVE_NONE,
     0,
     0,
     0,
     COMBAT_FACING_LOCK_AWAY,
     PHYS_BLUNT,
     ELEM_NONE,
     0,
     0,
     ...
     1,
     0,
     combat::WINDOW_HEAVY_TAIL_SPIN_0,
     4,
     34,
     18,
     62,
     8,
     TELL_ARC,
     combat_expect::ATTACK_HEAVY_TAIL_SPIN_ART_SHEET,
     combat_expect::ATTACK_HEAVY_TAIL_SPIN_ART_FRAME,
     combat_expect::ATTACK_HEAVY_TAIL_SPIN_ART_MODE},
    ...
    {MOVE_HOP,
     ...
     12,
     TELL_RING,
     combat_expect::ATTACK_HEAVY_TAIL_SLAM_ART_SHEET,
     combat_expect::ATTACK_HEAVY_TAIL_SLAM_ART_FRAME,
     combat_expect::ATTACK_HEAVY_TAIL_SLAM_ART_MODE},
    {MOVE_LUNGE,
     20,
     0,
     0,
     ...
     combat_expect::ATTACK_LUNGE_PECK_ART_SHEET,
     combat_expect::ATTACK_LUNGE_PECK_ART_FRAME,
     combat_expect::ATTACK_LUNGE_PECK_ART_MODE},
    ...
    {MOVE_NONE,
     ...
     combat_expect::ATTACK_SWEEP_STOMP_ART_SHEET,
     combat_expect::ATTACK_SWEEP_STOMP_ART_FRAME,
     combat_expect::ATTACK_SWEEP_STOMP_ART_MODE},
    ...
    {MOVE_LUNGE,
     ...
     14,
     TELL_LINE,
     combat_expect::ATTACK_SWEEP_GORE_ART_SHEET,
     combat_expect::ATTACK_SWEEP_GORE_ART_FRAME,
     combat_expect::ATTACK_SWEEP_GORE_ART_MODE},
    ...
    {MOVE_NONE,
     ...
     1,
     0,
     combat::WINDOW_SWEEP_REAR_KICK_0,
     1,
     14,
     4,
     30,
     10,
     TELL_ARC,
     combat_expect::ATTACK_SWEEP_REAR_KICK_ART_SHEET,
     combat_expect::ATTACK_SWEEP_REAR_KICK_ART_FRAME,
     combat_expect::ATTACK_SWEEP_REAR_KICK_ART_MODE},
};
