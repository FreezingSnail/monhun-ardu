...
void testZonePartSheets(Test &t) {
    ...
    if (parseBlob("fxlegs_chicken", cl, t)) {
        ...
        t.assert(art_dims::legs_chicken_frame_h, 16, "chicken legs frame h");
        t.assert(art_dims::legs_chicken_frames, 4, "chicken legs frames");
        t.assert(planeAtF(cl, 0, 0, 2, 7), 1, "chicken legs east near shank plane0");
        t.assert(planeAtF(cl, 0, 0, 7, 7), 1, "chicken legs east far shank plane0");
        t.assert(maskAtF(cl, 0, 5, 7), 0, "chicken legs east gap clear");
        t.assert(planeAtF(cl, 0, 0, 0, 8), 1, "chicken legs east foot plane0");
        t.assert(planeAtF(cl, 1, 0, 2, 7), 0, "chicken legs broken shank erased");
        t.assert(planeAtF(cl, 1, 0, 2, 0), 1, "chicken legs broken thigh stump plane0");
