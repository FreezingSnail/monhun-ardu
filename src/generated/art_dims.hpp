...
constexpr uint8_t legs_chicken_frame_h = 24;
constexpr uint8_t legs_chicken_frames = 4;
constexpr uint8_t head_bull_frame_w = 12;
constexpr uint8_t head_bull_frame_h = 16;
constexpr uint8_t head_bull_frames = 4;
constexpr uint8_t hooves_bull_frame_w = 20;
constexpr uint8_t hooves_bull_frame_h = 16;
