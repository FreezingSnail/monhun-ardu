...
constexpr uint32_t SHEET_MH_MAP_TENT_OFF = 22344;
constexpr uint8_t SHEET_FXPOLE = 1;
constexpr bool SHEET_FXPOLE_RESOLVED = true;
constexpr uint32_t SHEET_FXPOLE_OFF = 21142;
