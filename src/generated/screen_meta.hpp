...
constexpr uint16_t ROW_COUNT = 47;
...
constexpr uint16_t PAGE_TABLE_OFF = 778;
...
constexpr uint16_t SCREEN_HUB_PAGE_TABLE = 778;
...
constexpr uint16_t SCREEN_QUESTS_PAGE_TABLE = 791;
...
constexpr uint16_t SCREEN_FORGE_FIRST_ROW = 442;
constexpr uint8_t SCREEN_FORGE_PAGES = 1;
constexpr uint16_t SCREEN_FORGE_PAGE_TABLE = 817;
...
constexpr uint16_t SCREEN_CRAFT_FIRST_ROW = 512;
constexpr uint8_t SCREEN_CRAFT_PAGES = 2;
constexpr uint16_t SCREEN_CRAFT_PAGE_TABLE = 830;
...
constexpr uint16_t SCREEN_ARMOR_FORGE_FIRST_ROW = 635;
constexpr uint8_t SCREEN_ARMOR_FORGE_PAGES = 1;
constexpr uint16_t SCREEN_ARMOR_FORGE_PAGE_TABLE = 843;
...
constexpr uint16_t SCREEN_UPGRADE_FIRST_ROW = 732;
constexpr uint8_t SCREEN_UPGRADE_PAGES = 1;
constexpr uint16_t SCREEN_UPGRADE_PAGE_TABLE = 856;
