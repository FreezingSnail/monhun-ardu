...
constexpr uint16_t SIZE = 63;
constexpr uint8_t HEADER_SIZE = 8;
constexpr uint8_t DEF_OFF_OFF = 8;
constexpr uint16_t ROWS_OFF = 18;
constexpr uint8_t SCREEN_COUNT = 1;
...
constexpr uint16_t SCREEN_HUB_OFF = 10;
constexpr uint8_t SCREEN_HUB_ROWS = 3;
constexpr uint8_t SCREEN_HUB_TITLE_LEN = 3;
constexpr uint16_t SCREEN_HUB_FIRST_ROW = 18;
