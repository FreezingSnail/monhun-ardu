...
constexpr uint16_t PAGE_TABLE_OFF = 877;
...
constexpr uint16_t SCREEN_HUB_PAGE_TABLE = 877;
...
constexpr uint16_t SCREEN_QUESTS_PAGE_TABLE = 890;
...
constexpr uint16_t SCREEN_FORGE_PAGE_TABLE = 916;
...
constexpr uint16_t SCREEN_CRAFT_PAGE_TABLE = 929;
...
constexpr uint16_t SCREEN_ARMOR_FORGE_FIRST_ROW = 734;
constexpr uint8_t SCREEN_ARMOR_FORGE_PAGES = 1;
constexpr uint16_t SCREEN_ARMOR_FORGE_PAGE_TABLE = 942;
...
constexpr uint16_t SCREEN_UPGRADE_FIRST_ROW = 831;
constexpr uint8_t SCREEN_UPGRADE_PAGES = 1;
constexpr uint16_t SCREEN_UPGRADE_PAGE_TABLE = 955;
