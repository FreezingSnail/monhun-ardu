...
constexpr uint16_t PAGE_TABLE_OFF = 816;
...
constexpr uint16_t SCREEN_HUB_PAGE_TABLE = 816;
...
constexpr uint16_t SCREEN_QUESTS_PAGE_TABLE = 829;
...
constexpr uint16_t SCREEN_FORGE_PAGE_TABLE = 855;
...
constexpr uint16_t SCREEN_CRAFT_PAGE_TABLE = 868;
...
constexpr uint16_t SCREEN_ARMOR_FORGE_FIRST_ROW = 673;
constexpr uint8_t SCREEN_ARMOR_FORGE_PAGES = 1;
constexpr uint16_t SCREEN_ARMOR_FORGE_PAGE_TABLE = 881;
...
constexpr uint16_t SCREEN_UPGRADE_FIRST_ROW = 770;
constexpr uint8_t SCREEN_UPGRADE_PAGES = 1;
constexpr uint16_t SCREEN_UPGRADE_PAGE_TABLE = 894;
