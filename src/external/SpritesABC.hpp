...
struct SpritesABC {
    ...
    static void drawBasicFX(int16_t x, int16_t y, uint8_t w, uint8_t h, uint24_t image, uint8_t mode);

    static void drawSizedFX(int16_t x, int16_t y, uint8_t w, uint8_t h, uint24_t image, uint8_t mode, uint16_t frame);

    static void drawFX(int16_t x, int16_t y, uint24_t image, uint8_t mode, uint16_t frame);
};