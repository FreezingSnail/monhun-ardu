...
#else
inline uint8_t mhPgmReadU8(const uint8_t* p) { return *p; }
inline int8_t mhPgmReadI8(const int8_t* p) { return *p; }
inline uint16_t mhPgmReadU16(const uint16_t* p) { return *p; }
inline int16_t mhPgmReadI16(const int16_t* p) { return *p; }
inline uint32_t mhPgmReadU32(const uint32_t* p) { return *p; }
inline int32_t mhPgmReadI32(const int32_t* p) { return *p; }
inline bool mhPgmReadBool(const bool* p) { return *p; }
#endif
