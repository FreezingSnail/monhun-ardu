...
def pole_crack_frame(stage, flash):
    ...
    if stage == 2:
        ...
        rect(img, 0, 18, 20, 2, BLACK)      # upper band chunk
        rect(img, 0, 26, 20, 1, BLACK)      # lower band edge
        rect(img, 0, 27, 20, 2, BLACK)      # lower band chunk
        for x, y in ((2, 20), (5, 21), (8, 20), (11, 22), (14, 21), (17, 20)):
