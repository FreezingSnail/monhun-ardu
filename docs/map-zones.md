...
| ridge | `PROP_RIDGE_0` | herb | 1 | 40,16,8,8 |
| ridge | `PROP_RIDGE_1` | herb | 2 | 160,40,8,8 |
| ridge | `PROP_RIDGE_2` | ore | 1 | 352,16,8,8 |
| ridge | `PROP_RIDGE_3` | bug | 1 | 200,96,8,8 |
...
cavern and ridge (23 props total); `src/core/items.hpp` asserts
`PROPS_COUNT <= 32`.
